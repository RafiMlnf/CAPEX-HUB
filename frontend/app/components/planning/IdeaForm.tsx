    ...
    <form onSubmit={(e) => handleSubmit(e, false)} className="space-y-4 text-xs font-normal">
      ...
      <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
        ...
        <button
          ...
          title="Simpan usulan sebagai draft (belum dikirim ke Finance)"
        >
        ...
        {/* Kirim / Submit ke Finance Button */}
        <button
          type="button"
          ...
          title="Kirim dan teruskan usulan perencanaan ke Finance Review"
        >
          <svg className="w-3.5 h-3.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
          </svg>
          <span>{initialData ? "Update & Ajukan ke Finance" : "Submit ke Finance"}</span>
        </button>
      </div>
    </form>
  );
